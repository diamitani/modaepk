...
export function ArtworkDisplay({ artwork, onClick, className = "" }: ArtworkDisplayProps) {
  return (
    <Card
    ...
    >
      <div className="relative h-64 w-full">
        <Image src={artwork.image || "/placeholder.svg"} alt={artwork.title} fill style={{ objectFit: "cover" }} />
      </div>
