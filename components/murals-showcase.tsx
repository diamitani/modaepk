...
export function MuralsShowcase() {
  const [selectedArtwork, setSelectedArtwork] = useState<ArtworkItem | null>(null)

  // Filter for murals
  const murals = artworkData.filter((artwork) => artwork.category === "mural")

  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold mb-6">Murals & Installations</h2>
        ...
        {murals.map((artwork) => (
          ...
          >
            ...
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-700 mt-2">{artwork.description.split(".")[0]}.</p>
            </CardContent>
          </Card>
        ))}
      </div>
